...
1.  Features 1. Add a Life Update 1. Set visiblity - private/public 2. Set category - career, emotional, social, etc - **TBD** 1. **Self**
    → personal growth, mindset, habits, identity, hobbies 2. **Relationships**
    → partner, family, friends, social life 3. **Work**
    → career, job, professional development 4. **Money**
    → income, spending, savings, investments, possessions 5. **Health**
    → physical health, fitness, nutrition, sleep 6. **Life & Experiences**
